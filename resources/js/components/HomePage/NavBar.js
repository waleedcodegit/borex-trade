        ...
        <div className="uk-navbar-left">
          <div className="uk-navbar-item">
            ...
            <a className="uk-logo" href="index.html">
              <img src="/assets1/img/in-lazy.gif"  alt="logo" width={160} height={34}  />
            </a>
            {/* logo end */}
            {/* navigation begin */}
            <ul className="uk-navbar-nav d-block">
              <li><a href="index.html">Home<i className="fas fa-chevron-down" /></a>
